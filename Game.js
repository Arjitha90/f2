    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if (player.index !== null) {
                    ...
                    textSize(23);
                    fill("red");
                     text("player1 score:"+score1,40,100);
                     text("player2 score:"+score2,40,130);
                    ...
                    for (var i = 0; i < fruitGroup.maxDepth(); i++) { var fruit = fruitGroup.get(i); if (fruit != null && fruit.isTouching(players)) { fruit.destroy(); } }                                 
                   }
